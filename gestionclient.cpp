...
void GestionClient::on_ajouter_carte_clicked()
{
...
void GestionClient::on_ajouterClient_clicked()
{
...
void GestionClient::on_AfficherClient_activated(const QModelIndex &index)
{
...
void GestionClient::on_modifierClient_clicked()
{
...
void GestionClient::on_SupprimerClient_clicked()
{
    QString idd=ui->id_client->text();
    client *tmpCl=new client();
    if (idd=="")
...
void GestionClient::on_filtrerClient_clicked()
{
...
void GestionClient::on_recherchecase_3_cursorPositionChanged(int arg1, int arg2)
{
    client v;
...
void GestionClient::on_refresh_clicked()
{
    refraiche();
}

void GestionClient::on_closeClient_clicked()
{
    close();
}


void GestionClient::refraiche()
{
...
void GestionClient::Afficher_Client_Table(){
...
void GestionClient::Afficher_Carte_Table(){
...
void GestionClient::Afficher_Client_Table2(){
...
void GestionClient::on_SupprimerCarte_clicked()
{
...
void GestionClient::on_modifier_carte_clicked()
{
...
void GestionClient::on_refrech2_clicked()
{
    refraiche();
}

void GestionClient::on_AfficheCarteFidelite_2_activated(const QModelIndex &index)
{
...
void GestionClient::on_AfficherClient2_activated(const QModelIndex &index)
{
...
void GestionClient::on_recherchecase_4_cursorPositionChanged(int arg1, int arg2)
{
    client v;
...
void GestionClient::on_recherchecase_5_cursorPositionChanged(int arg1, int arg2)
{
    carte_fidelite v;
...
void GestionClient::on_close_2_clicked()
{
    close();
}
...
void GestionClient::on_envoyer_mail_clicked()
{

        sendMail("essai","essai esai");
